...
excel_fil = 'C:\Users\mclau\Documents\Andes_Data\Glacier Data\Hans Meyer\GS06\GS06.xlsx';
num = xlsread(excel_fil, 'GS06', '','basic'); %reads in excel file with dates being read in as numbers rather than strings
...
plot(Datetime, Avg, 'k.')
ylabel('Distance (mm)')
title('GS06 Distance to Surface')
