...
excel_fil = 'C:\Users\mclau\Documents\Andes_Data\Glacier Data\Reschrieter\GS03\GS03.xlsx';
num = xlsread(excel_fil, 'GS03', '','basic'); %reads in excel file with dates being read in as numbers rather than strings
...
plot(Datetime, Avg, 'k.')
ylabel('Distance (mm)')
title('GS03 Distance to Surface')
