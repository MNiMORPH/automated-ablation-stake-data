...
excel_fil = 'C:\Users\mclau\Documents\Andes_Data\Glacier Data\Reschrieter\GS02\GS02.xlsx';
num = xlsread(excel_fil, 'GS02', '','basic'); %reads in excel file with dates being read in as numbers rather than strings
...
plot(Datetime, Avg, 'k.')
ylabel('Distance (mm)')
title('GS02 Distance to Surface')
